...
export const configTheme: ThemeConfig = {
    token: {
        ...
        colorPrimaryBg: "var(--color-theme-primary)",
        ...
        colorErrorHover: "#ff7875", //btn error when hover
        colorErrorActive: "#d9363e",
        colorErrorTextHover: "#ff7875", //btn error when hover
        ...
        controlItemBgActive: "var(--color-theme-dropdown-active)",
        controlItemBgActiveHover: "#bae7ff",
        controlItemBgActiveDisabled: "rgba(0, 0, 0, 0.15)",
        controlTmpOutline: "rgba(0, 0, 0, 0.02)",
        controlOutline: "var(--color-theme-input-border)",
        ...
        // "_tokenKey": "oakhr7",
        // "_hashId": "css-dev-only-do-not-override-1h9m0go"
    },
};
